...
public class EveryHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table every(_id integer primary key autoincrement, todo text not null, cycle integer not null, date integer, day integer, category integer not null);");
    }
